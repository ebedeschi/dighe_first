...
//===========================================================================
{
  ...
  error = HAL_I2C_Mem_Read(&hi2c2, I2C_ADR_R, USER_REG_R, 1, buff, 2, 1000 );
//  I2c_StartCondition();
...
//  I2c_StopCondition();
  error = HAL_I2C_Mem_Write(&hi2c2, I2C_ADR_W, USER_REG_W, 1, pRegisterValue, 1, 1000);
  return error;
}
...
//  error |= I2c_WriteByte (I2C_ADR_W); // I2C Adr
  ...
  { case HUMIDITY:
	  	  	  	  	  ...
	  	  	  	  	  error |= HAL_I2C_Mem_Read(&hi2c2, I2C_ADR_R, TRIG_RH_MEASUREMENT_HM, 1, buff, 3, 2000);
	  	  	  	  break;
    case TEMP    :
    				  //error |= I2c_WriteByte (TRIG_T_MEASUREMENT_HM);
    				  error |= HAL_I2C_Mem_Read(&hi2c2, I2C_ADR_R, TRIG_T_MEASUREMENT_HM, 1, buff, 3, 2000);
    			  break;
  }
...
//  I2c_StopCondition();
  HAL_I2C_Mem_Write(&hi2c2, I2C_ADR_W, SOFT_RESET, 1, &data, 1, 1000);
